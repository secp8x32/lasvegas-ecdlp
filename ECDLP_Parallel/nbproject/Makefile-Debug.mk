...
${OBJECTDIR}/EC_DLP_utils.o: EC_DLP_utils.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EC_DLP_utils.o EC_DLP_utils.cpp

${OBJECTDIR}/EC_GF2E.o: EC_GF2E.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EC_GF2E.o EC_GF2E.cpp

${OBJECTDIR}/EC_GF2E_Point.o: EC_GF2E_Point.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EC_GF2E_Point.o EC_GF2E_Point.cpp

${OBJECTDIR}/dlp_input.o: dlp_input.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dlp_input.o dlp_input.cpp

${OBJECTDIR}/dlp_input_2m.o: dlp_input_2m.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dlp_input_2m.o dlp_input_2m.cpp

${OBJECTDIR}/lasVegasECDLP_26.o: lasVegasECDLP_26.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lasVegasECDLP_26.o lasVegasECDLP_26.cpp

${OBJECTDIR}/lasVegasUtils.o: lasVegasUtils.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lasVegasUtils.o lasVegasUtils.cpp
